...
namespace Hawk.Core.Utils
{
    ...
    public static class ExtendMethods
    {
        ...
        /// <returns></returns>
        public static T Get<T>(this ICollection<T> collection, string name, bool? isAddToList = true) where  T: class, IProcess
        {
            var process = collection.FirstOrDefault((d) => name == d.TypeName) as T;
            if (process != null) return process;
            XFrmWorkAttribute newProcess =
